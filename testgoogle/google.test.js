...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name('q')).sendKeys("java",Key.RETURN)
  await driver.wait(until.titleIs("java - Google Search"), 1000)
  ...
  await driver.findElement(By.name('q')).sendKeys("python", Key.RETURN)
  // TODO Wait for the results page to load
  await driver.wait(until.titleIs("python - Google Search"), 1000)
});
